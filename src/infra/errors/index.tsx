...
class BaseError extends Error {
    ...
    private context: any;
    private errorLocationCode: any;
    private key: any;
    private type: any;
    private databaseErrorCode: any;
    constructor({
                    message,
                    stack,
                    action,
...
export class InternalServerError extends BaseError {
    constructor({ message, action, requestId, errorId, statusCode, stack, errorLocationCode }: any) {
        super({
...
export class NotFoundError extends BaseError {
    constructor({ message, action, requestId, errorId, stack, errorLocationCode, key }: any) {
        super({
...
export class ServiceError extends BaseError {
    constructor({ message, action, stack, context, statusCode, errorLocationCode, databaseErrorCode }: any) {
        super({
...
export class ValidationError extends BaseError {
    constructor({ message, action, stack, statusCode, context, errorLocationCode, key, type }: any) {
        super({
...
export class UnauthorizedError extends BaseError {
    constructor({ message, action, requestId, stack, errorLocationCode }: any) {
        super({
...
export class TooManyRequestsError extends BaseError {
    constructor({ message, action, context, stack, errorLocationCode }: any) {
        super({
...
export class UnprocessableEntityError extends BaseError {
    constructor({ message, action, stack, errorLocationCode }: any) {
        super({
